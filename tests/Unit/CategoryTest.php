...
{
    /**
     * Test de l'entité Category, doit retourner qu'il fait partie de la classe Category
     *
     * @return void
     */
    public function testIsInstanceOf() : void
    {
        ...
        $resName = $entity->setName($value);
        $resColor = $entity->setColor($value);
        $resSlug = $entity->setSlug($value);
        $restCreation = $entity->setCreatedAt($date);
        $restUpdate = $entity->setUpdatedAt($date);

        self::assertInstanceOf(Category::class, $resName);
        self::assertInstanceOf(Category::class, $resColor);
        self::assertInstanceOf(Category::class, $resSlug);
        self::assertInstanceOf(Category::class, $restCreation);
        self::assertInstanceOf(Category::class, $restUpdate);
